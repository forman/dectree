...
CONFIG_DEFAULTS = {
    ...
    CONFIG_NAME_INPUTS_NAME:
        ['Inputs',
         'name of the generated class that holds the inputs; default is "{default}"', None],
    CONFIG_NAME_OUTPUTS_NAME:
        ['Outputs',
         'name of the generated class that holds the outputs; default is "{default}"', None],
    CONFIG_NAME_PARAMS_NAME:
        ['Params',
         'name of the generated class that holds the parameters; used with --parameterize; default is "{default}"',
         None],
