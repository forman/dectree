...
def eq(x1: float) -> _PropFuncResult:
    return dict(x1=float(x1)), (
        "return 1.0 if x == {x1} else 0.0"
    )


def ne(x1: float) -> _PropFuncResult:
    return dict(x1=float(x1)), (
        "return 1.0 if x != {x1} else 0.0"
    )


def gt(x1: float) -> _PropFuncResult:
    return dict(x1=float(x1)), (
        "return 1.0 if x > {x1} else 0.0"
    )


def ge(x1: float) -> _PropFuncResult:
    return dict(x1=float(x1)), (
        "return 1.0 if x >= {x1} else 0.0"
    )


def lt(x1: float) -> _PropFuncResult:
    return dict(x1=float(x1)), (
        "return 1.0 if x < {x1} else 0.0"
    )


def le(x1: float) -> _PropFuncResult:
    return dict(x1=float(x1)), (
        "return 1.0 if x <= {x1} else 0.0"
    )
